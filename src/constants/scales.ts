...
export const SCALE_SHAPE_POSITIONS: ScaleShapePosition[] = [
  {
    ...
    pattern: [
      ...
      { string: 2, fretOffset: 2, degree: 3, finger: 3 },
  ...
  },
  {
    ...
    pattern: [
      ...
      { string: 1, fretOffset: 2, degree: 6, finger: 3 },
      { string: 0, fretOffset: 0, degree: 1, finger: 1 },
      { string: 0, fretOffset: 2, degree: 2, finger: 3 }
    ],
    span: 4,
    rootPositions: [
      { string: 5, fretOffset: 0 },
  ...
  },
  {
    ...
    pattern: [
      { string: 5, fretOffset: 0, degree: 1, finger: 1 },
      { string: 5, fretOffset: 2, degree: 2, finger: 3 },
      { string: 5, fretOffset: 4, degree: 3, finger: 4 },
      { string: 4, fretOffset: 0, degree: 4, finger: 1 },
      { string: 4, fretOffset: 2, degree: 5, finger: 3 },
      { string: 4, fretOffset: 4, degree: 6, finger: 4 },
      { string: 3, fretOffset: 1, degree: 7, finger: 1 },
      { string: 3, fretOffset: 2, degree: 1, finger: 2 },
      { string: 3, fretOffset: 4, degree: 2, finger: 4 },
      { string: 2, fretOffset: 1, degree: 3, finger: 1 },
      { string: 2, fretOffset: 2, degree: 4, finger: 2 },
      { string: 2, fretOffset: 4, degree: 5, finger: 4 },
      { string: 1, fretOffset: 2, degree: 6, finger: 1 },
      { string: 1, fretOffset: 4, degree: 7, finger: 3 },
      { string: 1, fretOffset: 5, degree: 1, finger: 4 },
      { string: 0, fretOffset: 2, degree: 2, finger: 1 },
      { string: 0, fretOffset: 4, degree: 3, finger: 3 },
      { string: 0, fretOffset: 5, degree: 4, finger: 4 }
    ],
    span: 6,
    rootPositions: [
      { string: 5, fretOffset: 0 },
  ...
  },
  {
    ...
    pattern: [
      ...
      { string: 2, fretOffset: 4, degree: 5, finger: 4 },
      { string: 1, fretOffset: 1, degree: 6, finger: 1 },
      { string: 1, fretOffset: 3, degree: 7, finger: 3 },
      { string: 1, fretOffset: 5, degree: 1, finger: 4 },
      { string: 0, fretOffset: 0, degree: 2, finger: 1 },
      { string: 0, fretOffset: 2, degree: 3, finger: 3 },
      { string: 0, fretOffset: 3, degree: 4, finger: 4 }
    ],
    span: 6,
    rootPositions: [
